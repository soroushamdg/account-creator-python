...
while True:
    ...
    if command_first=="exit":
      ...
      funcs.create_mem(input_create_id,input_create_name, input_create_last, input_create_age, input_create_classname, **input_create_subjects)
    elif command_first == "load":
      input_load_id=input("Enter member id : ")
      funcs.load_mem(input_load_id)
